        ...
        <div className="px-8 md:px-12 pt-12 pb-8">
          <div className="grid sm:grid-cols-2 lg:grid-cols-5 gap-10 mb-10">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.facebook.com/YourBooks.GST.Accounting/" className="hover:text-primary-foreground transition-colors" target="_blank">
                  <Facebook size={18} />
                </a>
                <a href="https://www.instagram.com/yourbooks_in/" className="hover:text-primary-foreground transition-colors" target="_blank">
                  <Instagram size={18} />
                </a>
                <a href="https://www.youtube.com/@yourbooks_india" className="hover:text-primary-foreground transition-colors" target="_blank">
                  <Youtube size={18} />
                </a>
                <a href="https://www.linkedin.com/company/yourbooks-gst-accounting/posts/?feedView=all" className="hover:text-primary-foreground transition-colors" target="_blank">
                  <Linkedin size={18} />
                </a>
              </div>
            </div>
          ...
          <div className="border-t border-primary-foreground/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
            ...
            <div className="flex gap-6">
              ...
              <a href="/cancellation-refund-policy" className="hover:text-primary-foreground transition-colors">Cancellation Refund Policy</a>
