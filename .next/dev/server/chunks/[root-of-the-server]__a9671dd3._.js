...
async function logAction(userId, action) {
    await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].execute(`INSERT INTO audit_logs (user_id, action) VALUES (?, ?)`, [
        userId,
        action
    ]);
}
...
async function POST(req) {
    try {
        ...
        // Execute query
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$mysql$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].execute("SELECT * FROM users WHERE username = ?", [
            username
        ]);
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$lib$2f$audit$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logAction"])(user.id, "Admin logged in");
        return response;
    } catch (err) {
        console.error(err);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a9671dd3._.js.map