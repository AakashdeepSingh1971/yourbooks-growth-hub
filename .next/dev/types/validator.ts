...
// Validate ../../../app/(legal)/cancellation-refund-policy/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/cancellation-refund-policy">> = Specific
  const handler = {} as typeof import("../../../app/(legal)/cancellation-refund-policy/page.js")
...
// Validate ../../../app/api/system/log/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/system/log">> = Specific
  const handler = {} as typeof import("../../../app/api/system/log/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
